 ...
 */
final class Version20251229010243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quiz_question (id UUID NOT NULL, quiz_id UUID NOT NULL, question_id UUID NOT NULL, answer_id UUID DEFAULT NULL, answered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN quiz_question.answered_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE quiz_state_change (id UUID NOT NULL, quiz_id UUID NOT NULL, state VARCHAR(32) NOT NULL, changed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9F6AA474853CD175 ON quiz_state_change (quiz_id)');
        $this->addSql('COMMENT ON COLUMN quiz_state_change.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN quiz_state_change.quiz_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN quiz_state_change.changed_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE quiz_state_change ADD CONSTRAINT FK_9F6AA474853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
